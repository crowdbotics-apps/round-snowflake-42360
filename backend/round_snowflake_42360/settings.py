"""
Django settings for round_snowflake_42360 project.
...
ROOT_URLCONF = 'round_snowflake_42360.urls'
...
WSGI_APPLICATION = 'round_snowflake_42360.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_snowflake_42360 API",
    "DESCRIPTION": "API documentation for round_snowflake_42360 App",
    "VERSION": "v1",
}

...
## Project Structure
    ...
    ├── round_snowflake_42360  # Django project configurations
...
1. Clone this repo and `cd round_snowflake_42360`
...
2. Clone this repo and `cd round_snowflake_42360`
